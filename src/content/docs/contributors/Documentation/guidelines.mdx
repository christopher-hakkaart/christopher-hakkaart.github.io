...
<Aside type="tip">
See Markdown on the nf-core website for instructions on how to use markdown formatting and special elements such as _“admonitions”_ for nice formatting. You're reading an admonition right now!
</Aside>
